...
NIGHTLY = (ROOT / "scripts" / "nightly_semantic_maintenance.py").read_text()
...
assert "capped_or_incomplete_audit_rejected" in NIGHTLY
assert "rollback_tasks" in NIGHTLY and "cohort_verification_failed" in NIGHTLY
assert "nightly_semantic_maintenance.py" in WORKFLOW and "--live" in WORKFLOW
assert "ensure_overnight_dream_run.py" not in SLEEP_REPORT
