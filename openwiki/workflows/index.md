...
- [Source-first rebuild workflow](source-first-rebuild.md) - Two-hour staged build, retrieval verification, and atomic-promotion lifecycle for source-first memory generations.
