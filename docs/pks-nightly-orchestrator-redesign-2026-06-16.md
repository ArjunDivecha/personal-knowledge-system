...
| 4 | install one launchd orchestrator plist (old schedules stay active) | PRD written; implementation not started. See `docs/pks-nightly-orchestrator-phase-4-launchd-sidecar-prd-2026-06-17.md` |
