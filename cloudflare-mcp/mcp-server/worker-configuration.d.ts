/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d903d461d4857668edf04d9a310308ed)
// Runtime types generated with workerd@1.20260317.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "KnowledgeMCP" | "OpenAIKnowledgeMCP";
	}
	interface StagingEnv {
		OAUTH_KV: KVNamespace;
		DREAM_MAINTENANCE_QUEUE: Queue;
		...
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").KnowledgeMCP>;
		OPENAI_MCP_OBJECT: DurableObjectNamespace<import("./src/index").OpenAIKnowledgeMCP>;
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		DREAM_MAINTENANCE_QUEUE: Queue;
